...
<figure><img src="learning_Git/GajendraMahato/.files_for_readme/images/Generating a New SSH Key 0.png" alt=""><figcaption></figcaption></figure>
...
2.  In the upper-right corner of any page, click your **profile photo**,
    ...
    <figure><img src="learning_Git/GajendraMahato/.files_for_readme/images/Adding the SSH Key to Your GitHub Account 1.png" alt=""><figcaption></figcaption></figure>
3.  Then, click on **Settings**.

    <figure><img src="learning_Git/GajendraMahato/.files_for_readme/images/Adding the SSH Key to Your GitHub Account 2.png" alt=""><figcaption></figcaption></figure>
4.  In the user settings sidebar, click **SSH and GPG keys,** then click on "**New SSH key**"

    <figure><img src="learning_Git/GajendraMahato/.files_for_readme/images/Adding the SSH Key to Your GitHub Account 3.png" alt=""><figcaption></figcaption></figure>
5.  In the "Title" field, add a descriptive label for the new key. For example, if you're using a Linux on Virtual Machine, you might call this key "Linux on Virtual Machine". Then, Paste your public key into the "Key" field.
    ...
    <figure><img src="learning_Git/GajendraMahato/.files_for_readme/images/Adding the SSH Key to Your GitHub Account 4.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="learning_Git/GajendraMahato/.files_for_readme/images/Adding the SSH Key to Your GitHub Account 5.png" alt=""><figcaption></figcaption></figure>
...
1.  **Fork the repo on GitHub to your personal account.** Click the `Fork` button on the `gajabaar/2024-playground` Public page. (This needs to be done only once.)
    ...
    <figure><img src="learning_Git/GajendraMahato/.files_for_readme/images/Setting Up Your Own Copy of the Repository 0.png" alt=""><figcaption></figcaption></figure>
2.  After clicking the **Fork button**, we will be redirected to a page where we can customize our forked repository. Here, we don't need to make any changes, as everything looks fine. So, we processed by clicking on `Create fork` button.
    ...
    <figure><img src="learning_Git/GajendraMahato/.files_for_readme/images/Setting Up Your Own Copy of the Repository 1.png" alt=""><figcaption></figcaption></figure>
3.  **Clone the repository:** Click on the green `Code` button. It will open a small window. Then click on `SSH` and copy the repository's URL using the copy button or by manually selecting the URL. This URL will be copied to your clipboard. You can use this URL to clone the repository onto your local machine.
    ...
    <figure><img src="learning_Git/GajendraMahato/.files_for_readme/images/Setting Up Your Own Copy of the Repository 2.png" alt=""><figcaption></figcaption></figure>
    ...
    <figure><img src="learning_Git/GajendraMahato/.files_for_readme/images/Setting Up Your Own Copy of the Repository 3.png" alt=""><figcaption></figcaption></figure>
...
2. **List Existing Branches**:
   *   To view all existing branches in your local repository, use the command:
       ...
       <figure><img src="learning_Git/GajendraMahato/.files_for_readme/images/Adding Changes 0.png" alt=""><figcaption></figcaption></figure>
3.  **Create and Switch to a New Branch**:
    ...
    * After cloning the repository, create a new branch for your changes and switch to it:
    ...
    <figure><img src="learning_Git/GajendraMahato/.files_for_readme/images/Adding Changes 1.png" alt=""><figcaption></figcaption></figure>
...
4. **Make Changes and Commit**:
   *   Once you have switched to your branch, make your desired changes to the codebase:
       ...
       <figure><img src="learning_Git/GajendraMahato/.files_for_readme/images/Adding Changes 2.png" alt=""><figcaption></figcaption></figure>
...
5. **Push Your Changes**:
   *   Finally, push your committed changes to your forked repository on GitHub:
       ...
       <figure><img src="learning_Git/GajendraMahato/.files_for_readme/images/Adding Changes 3.png" alt=""><figcaption></figcaption></figure>
...
1. **Switch to Your Branch on GitHub**:
   *   Navigate to your forked repository on GitHub. Make sure you switch to the branch where you made your changes.
       ...
       <figure><img src="learning_Git/GajendraMahato/.files_for_readme/images/Opening a Pull Request on GitHub 0.png" alt=""><figcaption></figcaption></figure>
2. **Initiate a Pull Request**:
   *   Click on the green `Compare & pull request` button. If this button is not available, click on the `Contribute` button, then select `Open a pull request`.
       ...
       <figure><img src="learning_Git/GajendraMahato/.files_for_readme/images/Opening a Pull Request on GitHub 1.png" alt=""><figcaption></figcaption></figure>
...
4. **Open the Pull Request**:
   *   After describing your changes, click on the `Create pull request` button to open your pull request.
       ...
       <figure><img src="learning_Git/GajendraMahato/.files_for_readme/images/Opening a Pull Request on GitHub 2.png" alt=""><figcaption></figcaption></figure>
...
2.  **After Your Pull Request is Accepted**:
    ...
    1.  Ensure your local `main` branch is up-to-date:
        ...
        <figure><img src="learning_Git/GajendraMahato/.files_for_readme/images/Continue Working on the Same Branch 0.png" alt=""><figcaption></figcaption></figure>
    2.  Rebase your branch on `main` to incorporate any new changes:
        ...
        <figure><img src="learning_Git/GajendraMahato/.files_for_readme/images/Continue Working on the Same Branch 1.png" alt=""><figcaption></figcaption></figure>
